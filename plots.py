...
class Annotator:
    ...
    #def pintar_contador(self, size, cont,color=(0, 255, 255),txt_color=(255, 255, 255)):
    #            #txt = Image.new("RGBA", size, (255, 255, 255, 0))
    #    pun1, pun2 = (size[0], size[1]), (size[0] - 100, size[1] - 100)
    #    tf = max(self.lw - 1, 1)
    #    cv2.rectangle(self.im, pun1, pun2, color, thickness=self.lw, lineType=cv2.LINE_AA)
    #    cv2.putText(self.im,cont, (pun1[0], pun2[1] - 2),
    #                        0,
    #                        self.lw / 3,
    #                        txt_color,
    #                        thickness=tf,
    ...
    def box_label(self, box, size, cont, label='', color=(128, 128, 128), txt_color=(255, 255, 255)):
